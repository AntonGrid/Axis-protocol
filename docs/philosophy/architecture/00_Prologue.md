...
Работая над Axis, я всё чаще задавал себе один вопрос.
...
Постепенно стало очевидно, что именно эта мысль определяет всё дальнейшее развитие Axis.
...
Возможно, однажды Axis изменится до неузнаваемости.
...
Я не рассматриваю Axis как собственность.
