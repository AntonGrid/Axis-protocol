...
Если через десять лет совершенно другой инженер сможет реализовать Axis, не читая исходный код первой версии, значит архитектура действительно удалась.
...
Axis перестал восприниматься как программный продукт.
...
Axis начал формироваться как язык доверия между физическим и цифровым мирами.
...
Именно поэтому постепенно исчезла сама мысль о владении Axis.
...
Если однажды Axis станет полезным всему миру, он перестанет быть проектом отдельных разработчиков.
