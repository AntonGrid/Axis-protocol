...
Именно поэтому в Axis начали появляться Architecture Decision Records.
...
Именно поэтому многие решения в Axis принимались значительно дольше, чем их последующая реализация.
...
Но если фундаментальные принципы останутся правильными, новые поколения инженеров смогут снова и снова создавать Axis практически с нуля.
